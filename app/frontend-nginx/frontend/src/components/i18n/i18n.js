      ...
      EN: {
        translation: {
          description: {
            ...
            heading: [
              "CROP GUARD - YOUR CROP GUARDIAN",
              "AI-powered crop disease detection made easy. Sign up with us today!",
              "Join Us",
            ],
            home: [
              ...
              "Get started",
              "Aiding Indian Farmers with Technology",
              "One-Stop AI Solution for Crop Disease Detection",
              "Advanced AI Detection, Live Treatment Information, Teleconsulting with Experts and a Community Forum for Farmers.",
              "Get started",
