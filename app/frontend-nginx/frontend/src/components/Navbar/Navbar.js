...
export default function Navbar() {
  ...
  // Add Expert Dashboard link if user is expert or admin
  const expertNavigation = user?.type === 'expert' || user?.type === 'admin'
    ? [{ name: "Expert Dashboard", href: "/expert", current: false }]
    : [];
  ...
  const allNavigation = [...navigation, ...expertNavigation, ...adminNavigation];
